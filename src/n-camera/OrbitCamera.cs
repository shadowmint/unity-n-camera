...
namespace N.Package.Cameras
{
  ...
  [ExecuteInEditMode]
  [AddComponentMenu("N/Camera/OrbitCamera")]
  public class OrbitCamera : MonoBehaviour
  {
    ...
    public void Start()
    {
      if ((this.ringCenter != null) && (this.lookAt != null))
      {
        ...
        if (this.ringRadiusZoomHeightFactor > 1)
        {
          this.ringRadiusZoomHeightFactor = 1f;
        }
        if (this.ringRadiusZoomHeightFactor < 0)
        {
          this.ringRadiusZoomHeightFactor = 0f;
        }
      }
    }
    ...
    public void Update()
    {
      if ((this.ringCenter != null) && (this.lookAt != null))
      {
        if ((angle != _offset) || (ringRadius != _offsetZoom) || (_ringCenterOffset != ringCenterOffset) || (_ringCenter != ringCenter.transform.position) || (_lookAt != lookAt.transform.position))
        {
          this._ringCenterOffset = this.ringCenterOffset;
